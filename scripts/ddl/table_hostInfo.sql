...
CREATE TABLE HostInfo (
    ...
    , PhysicalMemoryKB BIGINT -- Physischer Speicher in KB
    ...
    , CONSTRAINT UQ_HostInfo_Hostname UNIQUE (Hostname, Domain, Subdomain) -- Eindeutiger Index auf Hostname, Domain und Subdomain
);

-- Indexe hinzufügen
CREATE INDEX IDX_HostInfo_Hostname ON HostInfo (Hostname);
GO
