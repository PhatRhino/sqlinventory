...
CREATE TABLE InstanceInfo (
    ...
    , HostID INT NOT NULL -- Fremdschlüssel zur HostInfo-Tabelle
    ...
    , MaxMemoryKB BIGINT NOT NULL -- Maximale Speicherzuweisung in KB
    ...
    , CONSTRAINT FK_Instance_HostInfo FOREIGN KEY (HostID) REFERENCES HostInfo(HostID) -- Fremdschlüssel zur HostInfo-Tabelle
);
